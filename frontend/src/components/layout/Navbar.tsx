            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
              ...
              <div className="flex flex-col space-y-2 pt-4">
                {auth.isAuthenticated ? (
                  ...
                  <>
                    <Link to="/login" onClick={() => setIsMenuOpen(false)}><Button variant="ghost" className="justify-start">Sign In</Button></Link>
                    <Link to="/register" onClick={() => setIsMenuOpen(false)}><Button className="justify-start">Get Started</Button></Link>
                  </>
                )}
              </div>
            </div>
